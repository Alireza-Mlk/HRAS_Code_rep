...
significant_events_fg <- frames_list %>%
  ...
  ### T1 ###
    ...
    #mutate(rank=sign(IncLevelDifference)*log2(IncLevelDifference)*(-log10(PValue))) %>%
    ungroup() %>%
  ...
  ### T5 ###
   ...
   PU3_RI_T1_C6_GSEA <- fgsea(pathways = gmt.file, 
                     stats    = ranks_1,
                     eps      = 0,
                     minSize  = 10,
                     maxSize  = 100)
  
   PU3_RI_T3_C6_GSEA <- fgsea(pathways = gmt.file, 
                              stats    = ranks_3,
                              eps      = 0,
                              minSize  = 10,
                              maxSize  = 100)

   PU3_RI_T5_C6_GSEA <- fgsea(pathways = gmt.file, 
                              stats    = ranks_5,
                              eps      = 0,
                              minSize  = 10,
                              maxSize  = 100)
   
   PU3_RI_T7_C6_GSEA <- fgsea(pathways = gmt.file, 
                              stats    = ranks_7,
                              eps      = 0,
                              minSize  = 10,
                              maxSize  = 100)
   
   PU3_RI_T1M_C6_GSEA <- fgsea(pathways = gmt.file, 
                              stats    = ranks_1M,
                              eps      = 0,
                              minSize  = 10,
                              maxSize  = 100)
   
   PU3_RI_T3M_C6_GSEA <- fgsea(pathways = gmt.file, 
                               stats    = ranks_3M,
                               eps      = 0,
                               minSize  = 10,
                               maxSize  = 100)
   
   PU3_RI_T5M_C6_GSEA <- fgsea(pathways = gmt.file, 
                               stats    = ranks_5M,
                               eps      = 0,
                               minSize  = 10,
                               maxSize  = 100)

   PU3_RI_T7M_C6_GSEA <- fgsea(pathways = gmt.file, 
                               stats    = ranks_7M,
                               eps      = 0,
                               minSize  = 10,
                               maxSize  = 100)   